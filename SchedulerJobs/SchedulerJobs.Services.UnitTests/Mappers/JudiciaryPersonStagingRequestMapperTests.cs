...
{
    public class JudiciaryPersonStagingRequestMapperTests
    {
        [Test]
        public void should_map_model_to_request()
        {
            ...
            // Act
            var result = JudiciaryPersonStagingRequestMapper.MapTo(model);
            ...
            result.Leaver.Should().Be(model.Leaver.ToString());
