...
hostBuilder.ConfigureServices((hostContext, services) =>
{
    ...
    SchedulerJobs.Sds.Program.RegisterJobs(services, args);
    SchedulerJobs.Sds.Program.RegisterServices(services, configuration);
});

hostBuilder.ConfigureAppConfiguration(SchedulerJobs.Sds.Program.ConfigureAppConfiguration);

var host = hostBuilder.Build();

await host.RunAsync();

namespace SchedulerJobs.Sds
{
    ...
    public static class Program
    {
        ...
        public static void RegisterJobs(IServiceCollection services, IEnumerable<string> args)
        {
