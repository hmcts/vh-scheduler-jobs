...
namespace SchedulerJobs.UnitTests.Services
{
    ...
    public class ELinksServiceTests
    {
        ...
        private readonly string _clientResponse = @"{
            ""Pagination"": {
            ""Results"": 200,
            ""Pages"": 2,
            ""CurrentPage"": 1,
        ...
        ""Results"": [
        {
            ""Id"": ""2da99a88-1b32-44f4-a19e-022a90b0bdca"",
            ""PerId"": 0,
            ""PersonalCode"": ""Code0"",
            ""Title"": ""Mr"",
            ""KnownAs"": null,
            ""FullName"": ""Name0 Surname0"",
            ""Surname"": ""Surname0"",
            ""PostNominals"": null,
            ""Sex"": ""M"",
            ""Disability"": false,
            ""Email"": ""name0.surname0@email.com"",
            ""WorkPhone"": ""01234567890"",
            ""RetirementDate"": null,
            ""LeavingOn"": null,
            ""Appointments"": null,
            ""Authorisations"": null,
            ""AuthorisationsWithDates"": null,
            ""TrainingRecords"": null,
            ""Leaver"": false,
            ""LeftOn"": null
        },
        {
        ""Id"": ""e90fbb4f-10f9-4dfc-a6f7-96017cca5816"",
        ""PerId"": 0,
        ""PersonalCode"": ""Code1"",
        ""Title"": ""Mr"",
        ""KnownAs"": null,
